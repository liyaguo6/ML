...
# 原始输入数据的目录，这个目录下有4个子目录，每个子目录底下保存这属于该
# 类别的所有图片。
...
def create_image_lists(testing_percentage, validation_percentage):
    """
    # 读取数据并将数据分割成训练数据、验证数据和测试数据。
    :param testing_percentage: 测试数据集比例
    :param validation_percentage: 验证数据集所占比例
    :return:
    """
    # ['D:\\datasets\\flower_photos', 'D:\\datasets\\flower_photos\\daisy', 'D:\\datasets\\flower_photos\\dandelion', 'D:\\datasets\\flower_photos\\roses', 'D:\\datasets\\flower_photos\\sunflowers']
